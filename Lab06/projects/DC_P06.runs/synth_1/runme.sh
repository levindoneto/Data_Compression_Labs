...
HD_PWD='/home/netolo/DC/P06/projects/DC_P06.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log run_length_encoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source run_length_encoder.tcl
