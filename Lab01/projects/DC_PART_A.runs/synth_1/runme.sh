...
HD_PWD='/home/netolo/DC/P01/PARTA/projects/DC_PART_A.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log moore_4s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source moore_4s.tcl
